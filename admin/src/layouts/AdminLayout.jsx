...
// //   const [counts, setCounts] = useState({ events: 0, speakers: 0, sponsors: 0 });
...
// //     try {
// //       const [evRes, spRes, spnRes] = await Promise.allSettled([
...
// //       setCounts({ events: 0, speakers: 0, sponsors: 0 });
// //     } finally {
...
// //   useEffect(() => {
// //     // load counts on mount and whenever route changes
// //     loadCounts();
...
// //   // unified toggle: on desktop -> collapse/expand, on mobile -> open overlay
// //   const toggleSidebar = () => {
// //     if (isDesktop) setCollapsed((c) => !c);
// //     else setOpen((o) => !o);
// //   };

// //   // Icon component (uses stroke-current so it inherits text color)
// //   const Icon = ({ name }) => {
...
// //             <path d="M8 7V3M16 7V3M3 11H21M5 21H19C20.1046 21 21 20.1046 21 19V8C21 6.89543 20.1046 6 19 6H5C3.89543 6 3 6.89543 3 8V19C3 20.1046 3.89543 21 5 21Z" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
// //           </svg>
// //         );
// //       case "mic":
// //         return (
// //           <svg className={base} viewBox="0 0 24 24" fill="none" aria-hidden>
// //             <path d="M12 1V13M5 8V9C5 13.4183 8.58172 17 13 17C17.4183 17 21 13.4183 21 9V8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
...
// //         return (
// //           <svg className={base} viewBox="0 0 24 24" fill="none" aria-hidden>
// //             <path d="M2 12L6 16L10 12L14 16L22 8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
// //           </svg>
// //         );
// //       case "users":
// //         return (
// //           <svg className={base} viewBox="0 0 24 24" fill="none" aria-hidden>
// //             <path d="M17 21V19C17 17.3431 15.6569 16 14 16H10C8.34315 16 7 17.3431 7 19V21" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
...
// //         return (
// //           <svg className={base} viewBox="0 0 24 24" fill="none" aria-hidden>
// //             <path d="M12 2L15 8L22 9L17 14L18 21L12 18L6 21L7 14L2 9L9 8L12 2Z" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
// //           </svg>
// //         );
// //       case "map":
// //         return (
// //           <svg className={base} viewBox="0 0 24 24" fill="none" aria-hidden>
// //             <path d="M20.5 3L15 5L8 3L3.5 5V19L9 17L16 19L20.5 17V3Z" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
// //           </svg>
// //         );
// //       default:
// //         return null;
...
// //   // compute sidebar width / main margin based on desktop & collapsed flags
// //   const sidebarWidthPx = isDesktop ? (collapsed ? 64 : 256) : 0;
// //   const mainStyle = isDesktop ? { marginLeft: sidebarWidthPx, transition: 'margin-left 200ms' } : {};

// //   // dashboard inner container height to fit the screen
// //   const dashboardInnerHeight = `calc(100vh - 96px)`; // leaves room for header
...
// //         className={`fixed inset-0 z-30 transition-opacity sm:hidden ${open ? "opacity-100 pointer-events-auto bg-black/60" : "opacity-0 pointer-events-none"}`}
// //         aria-hidden
// //       />
...
// //             {!collapsed && (
// //               <div>
// //                 <div className="text-lg font-extrabold tracking-tight text-white">TEDx SMEC</div>
...
// //           {/* mobile close button */}
// //           {!isDesktop && (
// //             <button className="p-2 rounded-md hover:bg-red-700/20 text-white" onClick={() => setOpen(false)} aria-label="Close sidebar">✕</button>
// //           )}
// //         </div>
...
// //                   to={m.to}
// //                   className={({ isActive }) =>
// //                     `group flex items-center w-full px-3 py-2 rounded-md text-sm font-medium transition-colors ${isActive ? "bg-red-600 text-white" : "text-white hover:bg-red-700/10"}`
// //                   }
...
// //           <button onClick={logout} className="w-full flex items-center px-3 py-2 rounded-md text-sm font-medium text-white hover:bg-red-700/10">
// //             <svg className="w-5 h-5 mr-3 flex-none stroke-current" viewBox="0 0 24 24" fill="none" aria-hidden>
// //               <path d="M16 17L21 12L16 7" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
// //               <path d="M21 12H9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
// //               <path d="M13 5H8C6.89543 5 6 5.89543 6 7V17C6 18.1046 6.89543 19 8 19H13" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
// //             </svg>
// //             {!collapsed && 'Logout'}
// //           </button>
// //         </div>
...
// //       <header className="fixed top-0 left-0 right-0 bg-black border-b border-red-800 p-2 z-30 flex items-center justify-between" style={{ height: 64 }}>
...
// //           <button onClick={loadCounts} className="px-3 py-1 rounded-md bg-red-600 text-white font-semibold hover:bg-red-700/90">Refresh</button>
// //           <button className="px-3 py-1 rounded-md border border-red-700 text-white hover:bg-red-700/10">Settings</button>
// //         </div>
// //       </header>
...
// //         style={{
// //           paddingTop: 64, // leave space for fixed topbar
// //           ...mainStyle
// //         }}
// //       >
// //         <div style={{ width: '100%', maxWidth: 1280, margin: '0 auto', padding: 0 }}>
// //           {/* header row */}
// //           <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 8px 0 8px' }}>
// //             <h1 style={{ margin: 0, fontSize: 22, fontWeight: 800 }}>Dashboard</h1>
// //           </div>

// //           {/* Dashboard container - fits screen height and sits flush next to sidebar */}
...
// //             }}>
// //               {/* Events card */}
// //               <div style={{ width: 260, minHeight: 140, borderRadius: 12, padding: 18, border: '1px solid rgba(178,13,18,0.18)', background: 'rgba(255,255,255,0.02)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
// //                 <div>
// //                   <div style={{ color: '#ff7b7b', fontWeight: 600, marginBottom: 6 }}>Events</div>
// //                   <div style={{ fontSize: 36, fontWeight: 800 }}>{loadingCounts ? '…' : counts.events}</div>
// //                 </div>
// //                 <div style={{ color: '#ff7b7b', fontSize: 12, marginTop: 8 }}>Last updated: {new Date().toLocaleString()}</div>
// //               </div>

// //               {/* Speakers card */}
// //               <div style={{ width: 260, minHeight: 140, borderRadius: 12, padding: 18, border: '1px solid rgba(178,13,18,0.18)', background: 'rgba(255,255,255,0.02)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
// //                 <div>
// //                   <div style={{ color: '#ff7b7b', fontWeight: 600, marginBottom: 6 }}>Speakers</div>
// //                   <div style={{ fontSize: 36, fontWeight: 800 }}>{loadingCounts ? '…' : counts.speakers}</div>
// //                 </div>
// //                 <div style={{ color: '#ff7b7b', fontSize: 12, marginTop: 8 }}>Manage speakers</div>
// //               </div>

// //               {/* Sponsors card */}
// //               <div style={{ width: 260, minHeight: 140, borderRadius: 12, padding: 18, border: '1px solid rgba(178,13,18,0.18)', background: 'rgba(255,255,255,0.02)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
// //                 <div>
// //                   <div style={{ color: '#ff7b7b', fontWeight: 600, marginBottom: 6 }}>Sponsors</div>
// //                   <div style={{ fontSize: 36, fontWeight: 800 }}>{loadingCounts ? '…' : counts.sponsors}</div>
// //                 </div>
// //                 <div style={{ color: '#ff7b7b', fontSize: 12, marginTop: 8 }}>Manage sponsors</div>
// //               </div>

// //               {/* Add more metric cards here if needed */}
// //             </div>

// //             {/* Route content below cards (scrolls inside dashboard area) */}
...
//       alt="TEDxSMEC Logo"
//       style={{
//         width: collapsed ? 48 : 72,   // bigger size
